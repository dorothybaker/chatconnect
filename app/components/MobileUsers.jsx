...
export default function MobileUsers({ userData, setSelectedChatroom }) {
  ...
  return (
    <div className="flex flex-col gap-1 sm:px-4 px-3 md:hidden">
        ...
        <button
          ...
          className={`${
            activeTab === "chats"
              ...
              : "text-foreground bg-background border-2 border-foreground/80"
          } px-3 py-1.5 rounded-lg cursor-pointer font-semibold`}
        >
          ChatRoom
        </button>
